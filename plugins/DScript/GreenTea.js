...
var KonohaGrammar = (function (_super) {
    ...
    KonohaGrammar.prototype.LoadTo = function (NameSpace) {
		...
		//FIX ME : written by me
		KonohaGrammar.ParseCommand = function (NameSpace, TokenContext, LeftTree, Pattern) {
			var CommandTree = TokenContext.CreateMatchedSyntaxTree(NameSpace, Pattern, "command");
			var Command = "";
		...
		NameSpace.AppendSyntax("command", LibLoadFunc.LoadParseFunc(Context, this, "ParseCommand"), null);
    };
